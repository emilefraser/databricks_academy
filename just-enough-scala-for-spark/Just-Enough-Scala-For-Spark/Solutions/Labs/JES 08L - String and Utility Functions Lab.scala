...
val lowerCaseStr = aString.toLowerCase
...
val wordsList = lowerCaseStr.split(' ') // The default separator is also a space
...
val newString = wordsList.mkString(",")
...
val absoluteValue = math.abs(aNumber) 
...
// Find the log value
val logValue = math.log10(anotherNumber) 
