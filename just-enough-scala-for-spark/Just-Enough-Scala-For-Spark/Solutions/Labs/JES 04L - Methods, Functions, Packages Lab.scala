...
def isArg1GreaterThanArg2(firstArg: Double, secondArg: Double): Boolean = {
  firstArg > secondArg
}

// Invoke the method with parameters 10.0, 20.0 and assign to variable firstResult
var firstResult = isArg1GreaterThanArg2(10.0, 20.0)

// Invoke the method with parameters 30.0, 20.0 and assign to variable secondResult
var secondResult = isArg1GreaterThanArg2(30.0, 20.0)
