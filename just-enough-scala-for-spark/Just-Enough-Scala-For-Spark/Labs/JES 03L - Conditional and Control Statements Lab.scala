...
// assign the tring literal “a is less than b” or “a is not less than b.” to a variable named result.
...
// Write a for loop to compute the sum of the all even number and odd numbers and store them sumOfEvens and sumOfOdds respectively
