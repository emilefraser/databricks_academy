...
# MAGIC DE 6.99.1 - [Manage principals in Unity Catalog]($./DE 6.99 - OPTIONAL Administration/DE 6.99.1 - Manage principals in Unity Catalog)<br>
...
# MAGIC DE 6.99.4 - [Manage Unity Catalog metastores]($./DE 6.99 - OPTIONAL Administration/DE 6.99.4 - OPTIONAL Manage Unity Catalog metastores)<br>
# MAGIC DE 6.99.5 - [Create External Tables in Unity Catalog]($./DE 6.99 - OPTIONAL Administration/DE 6.99.5 - OPTIONAL Create External Tables in Unity Catalog)<br>
# MAGIC 
# MAGIC 
# MAGIC #### Prerequisites
