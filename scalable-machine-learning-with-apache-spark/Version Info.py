...
# MAGIC %md <i18n value="ebdf53a8-2e92-41da-8b96-df365abf9d7c"/>
# MAGIC 
# MAGIC 
# MAGIC 
...
# MAGIC * Version:  **3.8.9**
# MAGIC * Built On: **Nov 3, 2022 at 18:59:36 UTC**
...
# MAGIC 
# MAGIC This course is tested against and requires one of the following DBRs (Databricks Runtime): **11.3.x-cpu-ml-scala2.12**.
# MAGIC 
