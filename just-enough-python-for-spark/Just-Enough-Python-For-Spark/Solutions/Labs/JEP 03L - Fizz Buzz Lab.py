...
# MAGIC 
# MAGIC The Fizz-Buzz test was invented by Imran Ghory to test candidates applying for various software development roles.
# MAGIC 
...
# MAGIC * You will need a for-loop that iterates over the numbers 0 to 100 inclusive.
# MAGIC * Inside the loop, you will need a combination of **`if`**, **`elif`** and **`else`** statements.
# MAGIC * The modulo (**`%`**) operator will give you the cleanest method for testing for divisibility by 3 and 5.
